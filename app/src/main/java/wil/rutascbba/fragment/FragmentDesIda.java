...
public class FragmentDesIda extends Fragment {
    List<ItemDes>  list = new ArrayList<>();
    Toolbar mToolbar;

    public FragmentDesIda() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_des_ida, container, false);
    ...
    private void initRecyclerView(View v) {
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.recyclerView_ida);
