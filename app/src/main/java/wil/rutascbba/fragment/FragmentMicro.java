...
public class FragmentMicro extends Fragment {
    List<ItemRecyclerView>  list = new ArrayList<>();
    Toolbar mToolbar;

    public FragmentMicro() {
    ...
    private void createItemList() {
        list = new ArrayList<>();
        for (int i = 0; i < 15; i++) {
            list.add(new ItemRecyclerView("LINEA" + i + "", "SINDICATO" + i, ContextCompat.getDrawable(getContext(), R.drawable.b)));
